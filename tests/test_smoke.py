...
from family_calendar.cli import main
from family_calendar.models import Note, ProjectState, Task
from family_calendar.cli import demo_state
from family_calendar.storage import load_state, save_state
from family_calendar.models import generate_short_id
from family_calendar.validation import normalize_tags, require_text, validate_task_status
from family_calendar.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
